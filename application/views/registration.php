                    ...
                    <div class="card mt-5">
                        ...
                        <div class="card-body">
                            <div class="form-floating mb-3">
                                <input class="form-control" id="no_daftar" type="text" placeholder="No Daftar" name="no_daftar">
                                <label for="no_daftar">No Daftar</label>
                            </div>
                            <div class="form-floating mb-3">
                                <select name="kode_kua" class="form-control">
                                    <?php foreach ($kode_kua as $kua) : ?>
                                        <option value="<?= $kua->id ?>"><?= $kua->id ?></option>
                                    <?php endforeach; ?>
                                </select>
